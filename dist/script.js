...
var forms = function forms() {
  var form = document.querySelectorAll("form"); // Получаем все формы

  var inputs = document.querySelectorAll("input"); // Получаем все инпуты
  ...
  form.forEach(function (item) {
    item.addEventListener("submit", function (e) {
      ...
      var statusMessage = document.createElement("div"); // Создаем DIV!!  для объекта messsage

      statusMessage.classList.add("status");
      item.appendChild(statusMessage); // Помещаем div в конец формы
      // Собираем данные с форм

      var formData = new FormData(item); // Здесь возвращаеться промис
